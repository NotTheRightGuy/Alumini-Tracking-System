function About() {
    return (
        <div>
            <h1 className="text-white text-4xl px-auto"> Alumni Tracker System(ATS)
...
ATS also facilitates mentorship and career support by enabling alumni to offer guidance to current students and seek advice from experienced professionals. This feature encourages collaboration and knowledge sharing within the alumni network, creating valuable opportunities for personal and professional growth.
Alumni Tracking Systems is dedicated to fostering a lifelong relationship between the college and its alumni. By providing a user-friendly platform for profile management, event updates, and news dissemination, we aim to strengthen the bond between alumni and their alma mater, promoting mutual growth and collaboration.
             </h1>
        </div>
    )
}
